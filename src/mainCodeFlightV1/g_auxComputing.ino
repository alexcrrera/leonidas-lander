...
// timeFlight moved to a_userParameters.ino (USER PARAMETER)
...
void resetIntegralAngle(){
  ...
  integralAngleY = 0.0;
  integralAngleZ = 0.0;
  integralPositionX = 0.0;
  integralPositionY = 0.0;
...
// timeFlightCheck moved to a_userParameters.ino (USER PARAMETER)
...
// RTK_2_LiDAR_RATIO moved to a_userParameters.ino (USER PARAMETER)
